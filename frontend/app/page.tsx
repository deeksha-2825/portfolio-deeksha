      ...
      >
         <div className="mx-auto max-w-4xl px-4 sm:px-12 lg:px-16 flex flex-col gap-y-24 lg:gap-y-32 py-12 lg:py-24 pb-32 lg:pb-48">
          ...
          >
            <Reveal>
              <h2 className="text-3xl font-bold tracking-tight text-white mb-6 flex items-center gap-3">
                 <FolderGit2 className="h-8 w-8 text-blue-400" /> Projects
              </h2>
            </Reveal>
